...
PLC2_DATA = {"SENSOR2-FL": "0"}  # interlock with PLC1
PLC3_DATA = {"SENSOR3-LL-bottle": "0"}  # interlock with PLC1
HMI_DATA = {"ACTUATOR1-MV": "0"}  # interlock with PLC1
...
HMI_SERVER = {"address": HMI_ADDR, "tags": HMI_TAGS}
HMI_PROTOCOL = {"name": "enip", "mode": 0, "server": HMI_SERVER}  # client only
